...
Enable `MESH_SCULPT_WARNINGS_AS_ERRORS` for strict builds. `MESH_SCULPT_ENABLE_SANITIZERS` enables address/undefined sanitizers only on supported non-Windows GCC/Clang configurations. Do not force these policies onto fetched code.
