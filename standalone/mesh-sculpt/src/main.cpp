...
int main()
{
    mesh_sculpt::platform::Window window(1280, 720, "Mesh Sculpt Tool");
    ...
    mesh_sculpt::render::FPSCamera camera(45.0f, 1280.0f / 720.0f, 0.1f, 100.0f);
    mesh_sculpt::sculpt::MeshSculptTool tool(&camera);
    mesh_sculpt::sculpt::MeshSculptUi ui;
    mesh_sculpt::app::MeshSculptController controller(window.nativeHandle());
    ...
    while (!window.shouldClose())
    {
        ...
        {
            case mesh_sculpt::sculpt::MeshSculptUi::FileAction::ResetMesh:
                tool.resetMesh();
                break;
            case mesh_sculpt::sculpt::MeshSculptUi::FileAction::Exit:
                glfwSetWindowShouldClose(window.nativeHandle(), GLFW_TRUE);
                break;
            case mesh_sculpt::sculpt::MeshSculptUi::FileAction::None:
                break;
        }
